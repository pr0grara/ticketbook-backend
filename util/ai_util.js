...
const preprocessorContextPath = path.join(__dirname, 'ai_instructions', 'preprocessor.txt');
...
const ai_preprocessor = async (req) => {
    ...
    const response = aiResponse.choices[0].message
    return response;
}

module.exports = {openai, ai_input_system_context, daily_plan_system_context, createAIInstructions, ai_preprocessor};